...
class TaskServiceTest {
 ...
 private TaskUpsertRequest life(String title){return new TaskUpsertRequest(title,TaskType.LIFE,TaskPriority.HIGH,TaskStatus.NOT_STARTED,LocalDateTime.now().plusDays(1),null,false,"家庭","备注","家庭",null,null);}
 ...
 @Test void createRejectsMissingLifeCategory(){var request=new TaskUpsertRequest("事项",TaskType.LIFE,TaskPriority.MEDIUM,TaskStatus.NOT_STARTED,null,null,false,null,null,"",null,null);assertThrows(BusinessException.class,()->service.create(1L,request));}
