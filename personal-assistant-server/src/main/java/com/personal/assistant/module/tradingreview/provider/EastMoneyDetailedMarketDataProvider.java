...
public class EastMoneyDetailedMarketDataProvider implements TradingMarketDataProvider {
    ...
    public MarketSnapshot fetch(LocalDate tradeDate) {
        ...
        rankings.set("turnover", safelyArray("\u677f\u5757\u6210\u4ea4\u989d\u699c", () -> sectorRanking("f6", 1, 1), warnings));
        rankings.set("rising", safelyArray("\u677f\u5757\u4e0a\u6da8\u699c", () -> sectorRanking("f3", 1, 1), warnings));
        rankings.set("falling", safelyArray("\u677f\u5757\u4e0b\u8dcc\u699c", () -> sectorRanking("f3", 0, 1), warnings));
        rankings.set("turnoverL2", safelyArray("\u4e8c\u7ea7\u884c\u4e1a\u6210\u4ea4\u989d\u699c", () -> sectorRanking("f6", 1, 2), warnings));
        rankings.set("risingL2", safelyArray("\u4e8c\u7ea7\u884c\u4e1a\u4e0a\u6da8\u699c", () -> sectorRanking("f3", 1, 2), warnings));
        rankings.set("fallingL2", safelyArray("\u4e8c\u7ea7\u884c\u4e1a\u4e0b\u8dcc\u699c", () -> sectorRanking("f3", 0, 2), warnings));
        rankings.set("turnoverL3", safelyArray("\u4e09\u7ea7\u884c\u4e1a\u6210\u4ea4\u989d\u699c", () -> sectorRanking("f6", 1, 3), warnings));
        rankings.set("risingL3", safelyArray("\u4e09\u7ea7\u884c\u4e1a\u4e0a\u6da8\u699c", () -> sectorRanking("f3", 1, 3), warnings));
        rankings.set("fallingL3", safelyArray("\u4e09\u7ea7\u884c\u4e1a\u4e0b\u8dcc\u699c", () -> sectorRanking("f3", 0, 3), warnings));
