...
export const getFinanceMonthlyAnalysis=(month:string,accountIds:number[]=[])=>http.get<unknown,{data:MonthlyAnalysis}>('/finance/stats/monthly-analysis',{params:{month,accountIds:accountIds.length?accountIds.join(','):undefined}});
