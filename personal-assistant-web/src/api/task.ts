...
export interface TaskItem { id:number;title:string;itemType:TaskType;priority:TaskPriority;status:TaskStatus;planTime:string|null;deadline:string|null;reminderEnabled:boolean;reminderAt:string|null;reminderSentAt:string|null;tags:string|null;remark:string|null;category:string|null;workType:string|null;projectName:string|null;statusChangedAt:string;createdAt:string;updatedAt:string; }
export interface TaskPayload { title:string;itemType:TaskType;priority:TaskPriority;status:TaskStatus;planTime:string|null;deadline:string|null;reminderEnabled:boolean;reminderAt:string|null;tags:string;remark:string;category:string;workType:string;projectName:string; }
