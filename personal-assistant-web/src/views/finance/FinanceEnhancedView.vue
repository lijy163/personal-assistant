...
const textImportVisible=ref(false),textInput=ref(''),textRows=ref<FinanceTextParseRow[]>([]),ignoredLineCount=ref(0),textAccountId=ref<number>(),textParsing=ref(false),textSaving=ref(false);
